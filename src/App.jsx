    ...
    <>
      <main>
        <div className="images">
          ...
          <img id="louisephone" src="/louisephone.png" alt="" />
          <img id="kiiak" src="/kiiak.png" alt="" />
        ...
        <section id="section-2">
          <div className="titles">
            ...
            <div img-id="navypier" className="title">
              <small>2018 - TODAY</small>
              <h1>Navy Pier</h1>
            </div>
            <div img-id="msichicago" className="title">
              <small>2015 - TODAY</small>
              <h1>MSI Chicago</h1>
            </div>
            <div img-id="louisephone" className="title">
              <small>2016</small>
              <h1>This Was Louise's Phone</h1>
            </div>
            <div img-id="kiiak" className="title">
            ...
            <div img-id="royalopera" className="title">
